...
def parse_args():
  ...
  args = [
    ...
    ('--train-period',  dict(default=4,      type=int,   help='train period in # *agent* steps')),
    ('--update-period', dict(default=10000,  type=int,   help='update target period in # *agent* steps')),
    ...
    ('--eval-period',   dict(default=250000, type=int,   help='period in # *agent* steps to run eval')),
