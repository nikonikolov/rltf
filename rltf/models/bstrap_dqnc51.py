...
class BaseBstrapDQNC51(BaseBstrapDQN):
  ...
  def _compute_loss(self, estimate, target):
    ...
    head_loss = super()._compute_loss(estimate_q, target_q)

    # z_loss    = C51._compute_loss(self, z, target_z)
...
class BstrapDQNC51_IDS(BaseBstrapDQNC51):
